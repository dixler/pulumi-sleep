...
export class Sleep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sleep:index:Sleep';
    ...
    public readonly seconds!: pulumi.Output<number>;
    ...
    constructor(name: string, args: SleepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.seconds === undefined) && !opts.urn) {
            ...
            resourceInputs["result"] = undefined /*out*/;
            resourceInputs["seconds"] = undefined /*out*/;
        }
