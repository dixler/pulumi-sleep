...
class SleepArgs:
    def __init__(__self__, *,
        ...
        """
        SleepArgs.__configure__(
            seconds=seconds,
            _setter=lambda key, value: pulumi.set(__self__, key, value),
        )
    @staticmethod
    def __configure__(*,
             seconds: pulumi.Input[int],
             _setter=lambda key, value: ...):
...
class Sleep(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Sleep resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if seconds is None and not opts.urn:
                raise TypeError("Missing required property 'seconds'")
            __props__.__dict__["seconds"] = seconds
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Sleep':
        """
        ...
        __props__.__dict__["result"] = None
        __props__.__dict__["seconds"] = None
    ...
    @property
    @pulumi.getter
    def seconds(self) -> pulumi.Output[int]:
        return pulumi.get(self, "seconds")
