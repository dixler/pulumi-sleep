...
namespace Pulumi.Sleep
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sleep.version.txt");
    ...
    internal sealed class SleepResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SleepResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
