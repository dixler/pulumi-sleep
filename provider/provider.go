...
func Provider() p.Provider {
	...
	return infer.Provider(infer.Options{
		Resources: []infer.InferredResource{
			infer.Resource[*Sleep, SleepArgs, SleepState](),
		},
...
func (*Sleep) Create(ctx p.Context, name string, input SleepArgs, preview bool) (string, SleepState, error) {
	state := SleepState{SleepArgs: input}
	if preview {
